...
export const Navbar = () => {
  ...
  return (
    ...
    >
      <nav
        className={`container-tight mx-4 md:mx-auto flex items-center justify-between rounded-full px-5 py-3 transition-all ${scrolled ? "glass shadow-elevated" : "bg-transparent"
          }`}
      >
        <a
          href="#top"
